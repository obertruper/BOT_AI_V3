...
from ..base.models import Position, Order, Balance, Ticker
...
class BybitLegacyAdapter:
    ...
    def __init__(self, api_key: str, api_secret: str, testnet: bool = False):
        ...
        self.logger = logger_factory.get_logger("bybit_adapter", component="exchange_adapter")
    ...
    def place_order(self, symbol: str, side: str, qty: Union[float, str], 
                   order_type: str = "Market", reduce_only: bool = False,
                   time_in_force: str = "GTC", price: Optional[float] = None,
    ...
    def get_wallet_balance(self, account_type: str = "UNIFIED") -> Dict[str, Any]:
        ...
        try:
            ...
            balances = loop.run_until_complete(
                self.client.get_balances(account_type)
            )
    ...
    def get_server_time(self) -> Dict[str, Any]:
        ...
        try:
            loop = asyncio.get_event_loop()
            server_time = loop.run_until_complete(
    ...
    def _convert_position_to_legacy(self, position: Position) -> Dict[str, Any]:
        ...
        return {
            ...
            "createdTime": str(int(position.created_time.timestamp() * 1000)) if position.created_time else "0",
            "updatedTime": str(int(position.updated_time.timestamp() * 1000)) if position.updated_time else "0"
        }
...
class BybitAPIClient(BybitLegacyAdapter):
    ...
    def _make_request(self, method: str, endpoint: str, params: Dict = None, auth: bool = False) -> Dict[str, Any]:
...
def get_bybit_client(api_key='', api_secret='', testnet=False, 
                    config_path=None, db_path=None) -> BybitAPIClient:
    """
