...
class ExchangeRegistry:
    ...
    def __init__(self):
        ...
        self.logger = logger_factory.get_logger("exchange_registry", component="exchanges")
    ...
    def get_exchanges_by_status(self, status: ExchangeStatus) -> Dict[ExchangeType, ExchangeMetadata]:
    ...
    def get_exchange_capabilities(self, exchange_type: ExchangeType) -> Optional[ExchangeCapabilities]:
    ...
    def validate_exchange_config(self, exchange_type: ExchangeType, 
