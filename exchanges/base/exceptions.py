...
from core.exceptions import (
    BaseTradingError, ErrorSeverity, ErrorCategory,
...
class InsufficientBalanceError(ExchangeError):
    ...
    def __init__(self,
        ...
        message = (f"Insufficient balance on {exchange_name}: "
...
def create_api_error_from_response(exchange_name: str,
                                 api_method: str,
                                 response_data: Dict[str, Any],
                                 status_code: Optional[int] = None) -> APIError:
...
def extract_retry_after(response_data: Dict[str, Any], headers: Optional[Dict[str, str]] = None) -> Optional[int]:
...
def map_exchange_error_code(error_code: str, 
                          exchange_name: str) -> type[ExchangeError]:
