...
from .order_types import OrderRequest, OrderResponse
...
class BaseExchangeInterface(ABC):
    ...
    async def get_trading_fees(self, symbol: str) -> dict[str, float]:
        ...
        return {
            "maker": 0.001,
            "taker": 0.001,
        }  # 0.1% по умолчанию  # 0.1% по умолчанию
    ...
    def validate_order_size(self, symbol: str, quantity: float) -> bool:
        ...
        return (
            quantity >= self.capabilities.min_order_size
            and quantity <= self.capabilities.max_order_size
        )
