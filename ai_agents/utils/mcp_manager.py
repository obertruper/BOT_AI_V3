...
class MCPManager:
    ...
    def _load_config(self):
        ...
        logger.info(f"Loaded {len(self.servers)} MCP servers and {len(self.agent_profiles)} agent profiles")
    ...
    def get_config_summary(self) -> str:
        ...
        for agent_type, profile in self.agent_profiles.items():
            ...
            lines.append(f"  - {agent_type}: [{servers}] (priority: {profile.get('priority', 'balanced')})")
