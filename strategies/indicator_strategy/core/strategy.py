...
class IndicatorStrategy(IndicatorStrategyBase):
    ...
    async def generate_signals(self, 
                             market_data_batch: List[MarketData]) -> List[TradingSignal]:
        """
    ...
    def get_risk_parameters(self) -> RiskParameters:
        ...
        return RiskParameters(
            ...
            partial_close_levels=self.risk_config.get('partial_close_levels', [
    ...
    async def on_signal_executed(self, 
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            'active_indicators': len(self.indicator_manager.get_indicators()) 
                               if self.indicator_manager else 0,
