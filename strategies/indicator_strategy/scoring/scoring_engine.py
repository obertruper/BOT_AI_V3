...
class ScoringEngine:
    ...
    def __init__(self,
        ...
        self.dynamic_calculator = DynamicWeightCalculator(regime_multipliers) \
    ...
    def calculate_score(self,
                       ...
                       market_regime: Optional[str] = None) -> ScoringResult:
        """
    ...
    def _calculate_category_scores(self, 
                                 indicators: Dict[str, Dict[str, Any]]) -> Dict[str, float]:
        """
        ...
        for category, category_indicators in indicators.items():
            ...
            if scores:
                ...
                if sum(strengths) > 0:
                    category_score = sum(s * w for s, w in zip(scores, strengths)) / sum(strengths)
                else:
    ...
    def _calculate_confidence(self,
        ...
        if total_indicators >= max_indicators:
            ...
            indicators_factor = 50 + (total_indicators - min_indicators) / \
                              (max_indicators - min_indicators) * 50
        else:
