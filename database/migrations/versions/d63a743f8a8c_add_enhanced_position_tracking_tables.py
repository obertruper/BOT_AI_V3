...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("idx_signal_fingerprints_symbol_direction"), table_name="signal_fingerprints"
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "signals", sa.Column("side", sa.VARCHAR(length=10), autoincrement=False, nullable=True)
    )
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            server_default=sa.text("'15m'::character varying"),
            autoincrement=False,
            nullable=True,
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "datetime", postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False
        ),
        ...
        sa.Column(
            "close_price", sa.NUMERIC(precision=20, scale=8), autoincrement=False, nullable=False
        ),
        ...
        sa.Column(
            "bb_position", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column("atr_pct", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
        sa.Column(
            "volume_ratio", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "trend_strength", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "features_mean", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "features_std", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "features_min", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "features_max", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "actual_direction_15m", sa.VARCHAR(length=10), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "actual_direction_12h", sa.VARCHAR(length=10), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "return_error_1h", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "return_error_4h", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "return_error_12h",
            sa.DOUBLE_PRECISION(precision=53),
        ...
        sa.UniqueConstraint(
            "symbol",
            "timestamp",
            name=op.f("uq_ml_predictions_symbol_timestamp"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    op.create_index(
        op.f("idx_ml_predictions_symbol_datetime"),
        "ml_predictions",
        ["symbol", "datetime"],
        unique=False,
    )
    op.create_index(
        op.f("idx_ml_predictions_signal_type"), "ml_predictions", ["signal_type"], unique=False
    )
    op.create_index(
        op.f("idx_ml_predictions_features_hash"), "ml_predictions", ["features_hash"], unique=False
    )
    op.create_index(
        op.f("idx_ml_predictions_datetime"), "ml_predictions", ["datetime"], unique=False
    )
    op.create_index(
        op.f("idx_ml_predictions_created_at"), "ml_predictions", ["created_at"], unique=False
    )
    op.create_index(
        op.f("idx_ml_predictions_confidence"), "ml_predictions", ["signal_confidence"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("idx_feature_importance_score"),
        "ml_feature_importance",
        ["importance_score"],
        unique=False,
    )
    op.create_index(
        op.f("idx_feature_importance_name"), "ml_feature_importance", ["feature_name"], unique=False
    )
    op.create_table(
        "partial_tp_history",
        ...
        sa.Column(
            "percent", sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False
        ),
        sa.Column(
            "close_ratio", sa.NUMERIC(precision=10, scale=4), autoincrement=False, nullable=False
        ),
        sa.Column(
            "close_qty", sa.NUMERIC(precision=20, scale=8), autoincrement=False, nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_partial_tp_history_trade_id"), "partial_tp_history", ["trade_id"], unique=False
    )
    op.create_index(
        op.f("ix_partial_tp_history_status"), "partial_tp_history", ["status"], unique=False
    )
    op.create_table(
        "signal_fingerprints",
        sa.Column("id", sa.BIGINT(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "signal_strength", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "price_level", sa.NUMERIC(precision=20, scale=8), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.UniqueConstraint(
            "signal_hash",
            name=op.f("uq_signal_fingerprints_hash"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    op.create_index(
        op.f("idx_signal_fingerprints_symbol_direction"),
        "signal_fingerprints",
        ["symbol", "direction"],
        unique=False,
    )
    op.create_index(
        op.f("idx_signal_fingerprints_symbol"), "signal_fingerprints", ["symbol"], unique=False
    )
    op.create_index(
        op.f("idx_signal_fingerprints_strategy"), "signal_fingerprints", ["strategy"], unique=False
    )
    op.create_index(
        op.f("idx_signal_fingerprints_created_at"),
        "signal_fingerprints",
        ["created_at"],
        unique=False,
    )
