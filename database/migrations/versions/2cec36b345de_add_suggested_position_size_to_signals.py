...
def upgrade() -> None:
    ...
    op.drop_index(op.f("idx_scheduler_metrics_cycle_start"), table_name="scheduler_metrics")
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("symbols_processed", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column("signals_generated", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "errors_count",
            sa.INTEGER(),
