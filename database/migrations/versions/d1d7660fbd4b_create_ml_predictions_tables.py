"""create_ml_predictions_tables

Revision ID: d1d7660fbd4b
Revises: 92146be3b870
Create Date: 2025-08-14 12:49:16.970164
...
revision = "d1d7660fbd4b"
down_revision = "92146be3b870"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("signal_timeframe", sa.String(10), nullable=False),
        # Model metadata
    ...
    # Create ml_feature_importance table
    op.create_table(
