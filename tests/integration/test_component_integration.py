...
class TestFullSystemIntegration:
    ...
    def complete_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config_data = {
                "system": {"name": "IntegrationTest", "version": "3.0.0", "environment": "testing"},
                "database": {
                    "host": "127.0.0.1",
                    "port": 5555,
                    "name": "integration_test",
                    "pool": {"min_connections": 2, "max_connections": 10},
                },
                "ml": {
                    "enabled": True,
                    "use_adapters": True,
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config_data = {
                "ml": {
                    "enabled": True,
                    "active_model": "patchtst",
                    "models": {"patchtst": {"enabled": True, "type": "PatchTST"}},
                },
                "database": {"port": 5555},
            }
