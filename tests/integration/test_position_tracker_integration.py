...
class TestPositionTrackerExchangeIntegration:
    ...
    async def exchange_tracker(self):
        ...
        mock_exchange.fetch_ticker.return_value = {"last": 50500.0, "bid": 50495.0, "ask": 50505.0}
...
class TestPositionTrackerAPIIntegration:
    ...
    async def test_cleanup_test_positions_endpoint(self, client):
        ...
        position_data = {"symbol": "BTCUSDT", "side": "long", "size": 0.001, "entry_price": 50000.0}
...
class TestPositionTrackerSystemIntegration:
    ...
    async def test_get_position_tracker_integration(
        self, mock_exchange_manager, mock_config_manager
    ):
