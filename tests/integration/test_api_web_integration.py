...
class TestAPIWebIntegration:
    ...
    async def test_api_health_check(self, api_base_url):
        ...
        health_endpoints = ["/health", "/status", "/version", "/metrics"]
    ...
    async def test_websocket_connection(self, ws_url):
        ...
        for msg_type in message_types:
            ...
            message = {"type": msg_type, "data": {}, "timestamp": datetime.now().isoformat()}
    ...
    async def test_pagination_and_filtering(self, api_base_url):
        ...
        paginated_endpoints = {
            ...
            "trades": {
                "path": "/trades",
                "params": {"page": 1, "limit": 50, "from": "2024-01-01", "to": "2024-12-31"},
            },
        }
    ...
    async def test_api_versioning(self, api_base_url):
        ...
        api_versions = {"v1": "/v1/status", "v2": "/v2/status", "latest": "/latest/status"}
