...
class TestModelAdapterFactory:
    ...
    def test_factory_create_adapter(self):
        ...
        config = {"model_file": "test_model.pth", "device": "cpu"}
    ...
    def test_factory_legacy_config(self):
        ...
        config = {"ml": {"enabled": True, "model": {"name": "UnifiedPatchTST", "device": "cpu"}}}
...
class TestPatchTSTAdapter:
    ...
    def adapter(self):
        ...
        config = {"model_file": "test_model.pth", "scaler_file": "test_scaler.pkl", "device": "cpu"}
    ...
    async def test_adapter_load(
        self, mock_analyzer, mock_fe, mock_pickle, mock_create_model, mock_torch_load, adapter
    ):
    ...
    def test_adapter_validate_input(self, adapter):
        ...
        valid_df = pd.DataFrame(
            np.random.randn(100, 5), columns=["open", "high", "low", "close", "volume"]
        )
...
class TestAsyncIntegration:
    ...
    async def test_adapter_update_model(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config = {"model_file": str(old_model), "device": "cpu"}
