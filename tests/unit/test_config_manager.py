...
from core.config.config_manager import ConfigInfo, ConfigManager, get_global_config_manager
from core.config.models import Environment, RootConfig, SystemSettings
...
class TestConfigManager:
    ...
    def temp_config_dir(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config_data = {
                ...
                "database": {"host": "127.0.0.1", "port": 5555, "name": "bot_trading_test"},
                "trading": {"hedge_mode": True, "orders": {"default_leverage": 5}},
                "ml": {"enabled": True, "use_adapters": True, "active_model": "patchtst"},
            }
    ...
    def test_load_config_validation_error(self, temp_config_dir):
        ...
        config_data = {"database": {"port": 3306}}  # Invalid port, should be 5555
    ...
    def test_update_system_config_success(self, config_manager):
        ...
        updates = {"system": {"name": "Updated_Name", "version": "3.1.0"}}
    ...
    def test_nested_value_extraction(self, config_manager):
        ...
        missing = config_manager._get_nested_value_from_pydantic(
            config, "system.nonexistent", "default"
        )
        assert missing == "default"
