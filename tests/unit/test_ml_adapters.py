...
class MockAdapter(BaseModelAdapter):
    ...
    def interpret_outputs(self, raw_outputs, **kwargs):
        ...
        from ml.adapters.base import RiskLevel, RiskMetrics, UnifiedPrediction
...
class TestModelAdapterFactory:
    ...
    def test_create_adapter_patchtst(self):
        ...
        config = {"model_file": "test_model.pth", "device": "cpu", "scaler_file": "test_scaler.pkl"}
    ...
    def test_create_from_config_model_disabled(self):
        ...
        config = {
            "ml": {
                "enabled": True,
                "active_model": "patchtst",
                "models": {"patchtst": {"enabled": False, "type": "PatchTST"}},
            }
        }
