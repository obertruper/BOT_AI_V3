...
class DataAdapters:
    ...
    def trader_to_response(self, trader) -> Dict[str, Any]:
        ...
        try:
            ...
            response = {
                ...
                "created_at": self._datetime_to_iso(getattr(trader, 'created_at', None)),
                "last_activity": self._datetime_to_iso(getattr(trader, 'last_activity', None))
            }
            ...
            try:
                ...
                response["current_position"] = self.position_to_response(position) if position else None
            except Exception as e:
    ...
    def positions_list_to_response(self, positions: List) -> List[Dict[str, Any]]:
        ...
        return [self.position_to_response(position) for position in positions if position is not None]
    ...
    def order_to_response(self, order) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "remaining_quantity": self._decimal_to_float(getattr(order, 'remaining_quantity', 0)),
    ...
    def exchange_to_response(self, exchange) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "display_name": getattr(exchange, 'display_name', getattr(exchange, 'name', 'unknown')),
                "status": "connected" if getattr(exchange, 'is_connected', lambda: False)() else "disconnected",
    ...
    def strategy_to_response(self, strategy) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "display_name": getattr(strategy, 'display_name', getattr(strategy, 'name', 'unknown')),
    ...
    def _remove_sensitive_data(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        def clean_dict(d):
            if isinstance(d, dict):
                return {
                    k: '***HIDDEN***' if any(sens in k.lower() for sens in sensitive_keys) else clean_dict(v)
                    for k, v in d.items()
                }
