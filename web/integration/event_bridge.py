...
class EventBridge:
    ...
    async def _on_trader_started(self, trader_id: str, trader_info: Dict[str, Any]):
        ...
        await self.emit_event(EventType.TRADER_STARTED, {
            "trader_id": trader_id,
    ...
    async def _on_trader_stopped(self, trader_id: str, reason: str = ""):
        ...
        await self.emit_event(EventType.TRADER_STOPPED, {
            "trader_id": trader_id,
            "reason": reason,
            "timestamp": datetime.now().isoformat()
        })
    ...
    async def _on_trade_executed(self, trade_data: Dict[str, Any]):
        ...
        await self.emit_event(EventType.TRADE_OPENED, {
    ...
    async def _on_position_changed(self, position_data: Dict[str, Any]):
        ...
        await self.emit_event(EventType.POSITION_UPDATED, {
    ...
    async def _on_exchange_connected(self, exchange_name: str):
        ...
        await self.emit_event(EventType.EXCHANGE_CONNECTED, {
    ...
    async def _on_exchange_disconnected(self, exchange_name: str, reason: str = ""):
        ...
        await self.emit_event(EventType.EXCHANGE_DISCONNECTED, {
            "exchange": exchange_name,
            "reason": reason,
            "timestamp": datetime.now().isoformat()
        })
    ...
    async def _periodic_heartbeat(self):
        ...
        while self._active:
            try:
                ...
                await self.emit_event(EventType.SYSTEM_STATUS_UPDATE, {
                    "status": "running",
    ...
    async def trigger_trader_event(self, trader_id: str, event_type: str, data: Dict[str, Any] = None):
    ...
    async def trigger_system_alert(self, level: str, message: str, component: str = "system"):
        ...
        await self.emit_event(EventType.SYSTEM_ALERT, {
            "level": level,
            "message": message,
            "component": component,
            "timestamp": datetime.now().isoformat()
