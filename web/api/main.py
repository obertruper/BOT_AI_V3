...
async def get_positions(trader_id: Optional[str] = None, bridge: WebOrchestratorBridge = Depends(get_web_bridge)):
...
async def start_web_server(host: str = "0.0.0.0", port: int = 8080, 
                          orchestrator=None, trader_manager=None, 
                          exchange_factory=None, config_manager=None):
    """
