...
from core.exceptions import TraderInitializationError, TraderConfigurationError
...
class TraderContext:
    ...
    async def _validate_config(self) -> None:
        ...
        validation_results = validator.validate_trader_config(self.trader_id, self._config['trader'])
