...
class TraderFactory:
    ...
    async def _validate_trader_config(self, trader_context: TraderContext) -> None:
        ...
        for warning in warnings:
            trader_context.logger.warning(f"Предупреждение конфигурации {warning.field}: {warning.message}")
    ...
    async def _inject_dependencies(self, trader_context: TraderContext, components: TraderComponents) -> None:
