...
class TraderInitializationError(TraderError):
    ...
    def __init__(self, message: str, trader_id: str, failed_component: Optional[str] = None, **kwargs):
...
class TraderConfigurationError(TraderError):
    ...
    def __init__(self, message: str, trader_id: str, config_field: Optional[str] = None, **kwargs):
...
class TraderManagerError(BaseTradingError):
    ...
    def __init__(self, message: str, affected_traders: Optional[List[str]] = None, **kwargs):
        super().__init__(
            message,
            severity=ErrorSeverity.HIGH,
            category=ErrorCategory.TRADER,
...
class UnsupportedExchangeError(ExchangeError):
    ...
    def __init__(self, exchange_name: str, supported_exchanges: Optional[List[str]] = None, **kwargs):
...
class StrategyError(BaseTradingError):
    ...
    def __init__(self, message: str, strategy_name: str, trader_id: Optional[str] = None, **kwargs):
        super().__init__(
            message,
            severity=ErrorSeverity.MEDIUM,
...
class UnsupportedStrategyError(StrategyError):
    ...
    def __init__(self, strategy_name: str, supported_strategies: Optional[List[str]] = None, **kwargs):
...
class OrderValidationError(ValidationError):
    ...
    def __init__(self, reason: str, order_data: Optional[Dict[str, Any]] = None, **kwargs):
...
def handle_and_log_error(logger, error: Exception, context: Optional[Dict[str, Any]] = None) -> BaseTradingError:
    """
