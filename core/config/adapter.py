...
class ConfigAdapter:
    ...
    def __init__(self, use_new_system: bool = False, profile: str = "development"):
        ...
        self._old_manager: ConfigManager | None = None
    ...
    def _initialize(self) -> None:
        ...
        if self.use_new_system:
            try:
                ...
                logger.warning(
                    f"⚠️ Не удалось загрузить новую систему: {e}, переключаемся на старую"
                )
    ...
    def migrate_to_new_system(self) -> bool:
        ...
        try:
            ...
            test_keys = ["system.name", "database.port", "trading.orders.default_leverage"]
