...
class ConfigManager:
    ...
    def get_config(self, key: str = None, default: Any = None, force_reload: bool = False) -> Any:
        ...
        Args:
            key: Ключ для поиска. Если None, возвращает всю конфигурацию как dict.
        ...
        if key is None:
            # Возвращаем конфигурацию как dict для совместимости
            if hasattr(self._config, "model_dump"):
                return self._config.model_dump()
            elif hasattr(self._config, "dict"):
                return self._config.dict()
            else:
                # Fallback - возвращаем сам объект
                return self._config
    ...
    def _load_config(self) -> None:
        ...
        try:
            ...
            self._config_info = ConfigInfo(
                path=str(config_path), loaded_at=datetime.now(), is_valid=True
            )
            self._is_initialized = True
    ...
    def _get_nested_value_from_pydantic(
        self, config: RootConfig, key: str, default: Any = None
    ) -> Any:
