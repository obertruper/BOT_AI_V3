...
from core.logging.logger_factory import LoggerFactory, get_global_logger_factory
...
class SystemOrchestrator:
    ...
    def __init__(self, config_manager: Optional[ConfigManager] = None):
        ...
        self.logger = self.logger_factory.get_logger("orchestrator", component="system_orchestrator")
        ...
        self.health_check_interval = self.system_config.get('monitoring', {}).get('health_check_interval', 30)
    ...
    async def _check_system_requirements(self) -> None:
        ...
        if resources['memory_available_mb'] < 512:
            raise SystemInitializationError("Недостаточно доступной памяти (требуется минимум 512MB)")
    ...
    async def _initialize_database(self) -> None:
        ...
        try:
            self.db_manager = ConnectionManager(self.config_manager.get_database_config())
