...
class VisualWebTester:
    ...
    async def test_performance_metrics(self):
        ...
        try:
            ...
            passed = (
                metrics["pageLoadTime"] < 3000 and
                metrics["domContentLoaded"] < 2000 and
    ...
    async def test_accessibility(self):
        ...
        try:
            ...
            print(f"  ✓ ARIA элементы: найдено")
            print(f"  ✓ Фокусируемые элементы: найдено")
    ...
    async def generate_report(self):
        ...
        report_file = self.screenshots_dir / f"report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
