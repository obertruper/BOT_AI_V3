...
async def start_simple_api():
    ...
    async def health_check():
        ...
        return {"status": "healthy", "message": "API is running", "version": "3.0.0"}
    ...
    async def get_balances():
        ...
        try:
            ...
            if bybit_keys and bybit_keys.get("api_key"):
                ...
                return {"status": "error", "message": "Bybit API keys not configured"}
    ...
    async def root():
        ...
        return {
            "name": "BOT_AI_V3 API",
            "version": "3.0.0",
            "endpoints": ["/health", "/api/trading/status", "/api/trading/balances", "/docs"],
        }

    # Configure uvicorn
    config = uvicorn.Config(app, host="127.0.0.1", port=8080, log_level="info", access_log=True)
