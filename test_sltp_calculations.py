    ...
    test_cases = [
        {
            ...
            "risk_metrics": [0.008, 0.015, 0.02, 0.03]  # max_drawdown_1h, max_rally_1h, max_drawdown_4h, max_rally_4h
        },
        {
    ...
    edge_cases = [
        {
            ...
            "risk_metrics": [0.001, 0.001, 0.001, 0.001]
        },
        {
            "name": "Максимальная волатильность",
            "risk_metrics": [0.05, 0.05, 0.05, 0.05]
        },
        {
            "name": "Асимметричная волатильность",
            "risk_metrics": [0.001, 0.05, 0.05, 0.001]
        }
    ]
