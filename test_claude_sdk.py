...
from ai_agents.claude_code_sdk import ClaudeCodeSDK, ClaudeCodeOptions, ThinkingMode
...
async def test_sdk_connection():
    ...
    try:
        ...
        print(f"❌ Ошибка: Claude CLI не найден")
        print(f"   Детали: {e}")
        print("\n💡 Решение:")
        print("   1. Убедитесь что Claude Code установлен: npm install -g @anthropics/claude-code")
